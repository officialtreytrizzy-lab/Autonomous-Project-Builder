...
test('desktop staging purges traced runtime and E2E state before package validation', () => {
  ...
  try {
    ...
    assert.equal(existsSync(join(standaloneDirectory, '.next_build', 'static', 'chunk.js')), true);
    assert.equal(existsSync(join(standaloneDirectory, '.next', 'static', 'chunk.js')), false);
